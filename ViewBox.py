    ...
    * Item coordinate mapping methods
    ...
    def wheelEvent(self, ev, axis=None):
        ...
        if self.CtrlPress:
            ...
            ds_unit = self.frame.ds/self.frame.parent.Frequency
            movetime = (((self.frame.parent.TimeScale*0.05)//(1/self.frame.parent.Frequency)/self.frame.parent.Frequency)//ds_unit)*ds_unit
            if ev.delta() > 0:
                movetime = movetime * -1
            self.frame.parent.playtime += movetime
